...
namespace SPMeta2.VS.CSharp.Extensions
{
    public static class ModelNodeExtensions
    {
        ...
        public static ListModelNode SpecsSetDefaultListContentType(this ListModelNode node, ContentTypeDefinition contentTypeDefinition)
        {
            return SpecsSetDefaultListContentType(node, contentTypeDefinition.Name);
        }
        ...
        /// <returns></returns>
        public static ListModelNode SpecsSetDefaultListContentType(this ListModelNode node, string contentTypeName)
        {
            // do some stuff
